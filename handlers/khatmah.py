    ...
    def handle_khatmah_buttons(call):
        ...
        if action == "info":
            ...
            bot.edit_message_text(
                ...
                "✨ لا تحرم نفسك هذا الفضل، وكن شريكًا في ختمة مباركة يُكتب لك بها أجر الخاتمين، ويُرفع بها ذكرك، وتُغفر بها ذنوبك.\n\n"
                "📌 اضغط على زر الانضمام، وابدأ رحلتك مع القرآن... *فالعمر يمضي، والقرآن باقي* 💚",
